...
const RegisterForm = () => {
  ...
  return (
    <div className="flex items-center justify-center h-screen">
      <form className="bg-gray-300 shadow-md rounded px-8 pt-6 pb-8 mb-4 w-1/3" onSubmit={handleSubmit}>
        <h2 className="text-2xl font-bold mb-6 mt-5 text-center">Register</h2>
        <div className="mb-4">
